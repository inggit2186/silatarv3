<x-admin.layouts.app>
    <div class="page-header">
        <div class="page-header-content">
            ...
            <p class="page-subtitle">Perbarui data layanan</p>
        </div>
    </div>
    ...
    <div class="card" style="max-width: 768px;">
        <div class="card-body">
            <div class="empty-state">
                ...
                <p class="empty-state-text">Form edit layanan akan segera tersedia.</p>
                <a href="{{ route('admin.services.index') }}" class="btn btn-secondary mt-4">Kembali</a>
            </div>
        </div>
    </div>
</x-admin.layouts.app>
