        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($acara->filename)
                <div class="card overflow-hidden p-0">
                    <img src="{{ asset('storage/acara/' . $acara->filename) }}" alt="{{ $acara->judul }}" class="w-full h-64 object-cover">
                    <div class="card-body">
                        <h2 class="text-xl font-bold text-gray-900">{{ $acara->judul }}</h2>
                        <p class="text-sm text-gray-500">{{ $acara->lokasi }}</p>
                    </div>
                </div>
            @endif
                ...
                <div class="card-body">
                    <div class="space-y-4">
                        ...
                        @if($acara->filename)
                            <hr class="border-gray-200">
                            <div class="flex items-start gap-4">
                                <div class="stat-icon rose" style="width: 48px; height: 48px;">
                                    <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-sm text-muted mb-1">Foto Acara</p>
                                    <button type="button" onclick="showPhotoModal('{{ asset('storage/acara/' . $acara->filename) }}')" class="text-blue-600 hover:text-blue-800 text-sm">
                                        Lihat Foto
                                    </button>
                                </div>
                            </div>
