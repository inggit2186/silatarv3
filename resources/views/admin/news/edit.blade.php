<x-admin.layouts.app title="{{ $title }}">
    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <p class="page-subtitle">Perbarui berita atau pengumuman untuk portal SILATAR</p>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title', $news->title) }}" required class="form-input" placeholder="Masukkan judul berita...">
                            @error('title')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="excerpt" rows="3" required class="form-input" style="height: auto; padding: 10px 12px;" placeholder="Ringkasan singkat berita (maks 500 karakter)...">{{ old('excerpt', $news->excerpt) }}</textarea>
                            @error('excerpt')
                            <p class="text-danger text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $news->meta_title ?? '') }}" maxlength="70" class="form-input" placeholder="Judul untuk SEO...">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3" maxlength="160" class="form-input" style="height: auto; padding: 10px 12px;" placeholder="Deskripsi untuk SEO...">{{ old('meta_description', $news->meta_description ?? '') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $news->meta_keywords ?? '') }}" class="form-input" placeholder="kemenag, agama, tanah datar...">
                        ...
                        <div style="border: 1px solid var(--border); border-radius: var(--radius); padding: 16px; background: var(--secondary-light);">
                            ...
                            <div id="seo_preview">
                                <p id="seo_preview_title" style="font-size: 16px; color: #1a0dab; text-decoration: underline; margin: 0;">{{ $news->meta_title ?: $news->title }} - SILATAR</p>
                                <p id="seo_preview_url" style="font-size: 14px; color: #006621; margin: 2px 0;">tanahdatar.kemenag.go.id/berita/{{ $news->slug }}</p>
                                <p id="seo_preview_desc" style="font-size: 13px; color: #545454; margin: 0;">{{ $news->meta_description ?: Str::limit($news->excerpt, 160) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="datetime-local" name="publish_date" value="{{ old('publish_date', $news->publish_date ? \Carbon\Carbon::parse($news->publish_date)->format('Y-m-d\TH:i') : \Carbon\Carbon::now()->format('Y-m-d\TH:i')) }}" class="form-input">
                            </div>

                            <div class="flex items-center gap-3">
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $news->is_featured) ? 'checked' : '' }} class="w-4 h-4">
                                <label for="is_featured" class="text-sm" style="color: var(--text-primary);">Tampilkan di Featured</label>
                            </div>

                            <div class="flex items-center gap-3">
                                <input type="checkbox" name="is_slideshow" id="is_slideshow" value="1" {{ old('is_slideshow', $news->is_slideshow) ? 'checked' : '' }} class="w-4 h-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="space-y-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" name="writer" value="{{ old('writer', $news->writer ?? '') }}" class="form-input" placeholder="Nama penulis...">
                            </div>

                            <div class="form-group mb-0">
                                <label class="form-label">Editor</label>
                                <input type="text" name="editor" value="{{ old('editor', $news->editor ?? '') }}" class="form-input" placeholder="Nama editor...">
                            </div>

                            <div class="form-group mb-0">
                                <label class="form-label">Fotografer</label>
                                <input type="text" name="photographer" value="{{ old('photographer', $news->photographer ?? '') }}" class="form-input" placeholder="Nama fotografer...">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if($news->image)
                        <div class="mb-4 rounded-lg overflow-hidden border" style="border-color: var(--border);">
