    ...
    <div class="neo-page-header">
        <div class="flex items-center gap-4">
            ...
            <div class="neo-page-header-content">
                ...
                <h1 class="neo-page-title">Edit Berita</h1>
                <p class="neo-page-subtitle">Perbarui berita atau pengumuman untuk portal SILATAR</p>
            </div>
        </div>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="neo-card">
                    <div class="neo-card-body">
                        ...
                        <input type="text" name="title" value="{{ old('title', $news->title) }}" required class="neo-form-input" placeholder="Masukkan judul berita...">
                        @error('title')
                ...
                <div class="neo-card">
                    <div class="neo-card-body">
                        ...
                        <textarea name="excerpt" rows="3" required class="neo-form-textarea" placeholder="Ringkasan singkat berita (maks 500 karakter)...">{{ old('excerpt', $news->excerpt) }}</textarea>
                        @error('excerpt')
                        <p class="neo-form-error">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="neo-card">
                    <div class="neo-card-body">
                        ...
                        <div id="editor" contenteditable="true" class="neo-editor">{!! old('content', $news->content) !!}</div>
                ...
                <div class="neo-card">
                    <div class="neo-card-body">
                        ...
                        <div class="neo-form-group">
                            ...
                            <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $news->meta_title ?? '') }}" maxlength="70" class="neo-form-input" placeholder="Judul untuk SEO...">
                        ...
                        <div class="neo-form-group">
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3" maxlength="160" class="neo-form-textarea" placeholder="Deskripsi untuk SEO...">{{ old('meta_description', $news->meta_description ?? '') }}</textarea>
                        ...
                        <div class="neo-form-group">
                            ...
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $news->meta_keywords ?? '') }}" class="neo-form-input" placeholder="kemenag, agama, tanah datar...">
                        ...
                        <div class="neo-seo-preview">
                            ...
                            <div id="seo_preview" class="neo-seo-preview-content">
                                <p id="seo_preview_title" class="neo-seo-preview-title">{{ $news->meta_title ?: $news->title }} - SILATAR</p>
                                <p id="seo_preview_url" class="neo-seo-preview-url">tanahdatar.kemenag.go.id/berita/{{ $news->slug }}</p>
                                <p id="seo_preview_desc" class="neo-seo-preview-desc">{{ $news->meta_description ?: Str::limit($news->excerpt, 160) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="neo-card-body">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="neo-form-group">
                                ...
                                <input type="datetime-local" name="publish_date" value="{{ old('publish_date', $news->publish_date ? \Carbon\Carbon::parse($news->publish_date)->format('Y-m-d\TH:i') : \Carbon\Carbon::now()->format('Y-m-d\TH:i')) }}" class="neo-form-input">
                            </div>

                            <div class="flex items-center gap-3">
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $news->is_featured) ? 'checked' : '' }} class="neo-checkbox">
                                <label for="is_featured" class="text-sm" style="color: var(--ink);">Tampilkan di Featured</label>
                            </div>

                            <div class="flex items-center gap-3">
                                <input type="checkbox" name="is_slideshow" id="is_slideshow" value="1" {{ old('is_slideshow', $news->is_slideshow) ? 'checked' : '' }} class="neo-checkbox">
                    ...
                    <div class="neo-card-body">
                        ...
                        <div class="space-y-4">
                            <div class="neo-form-group">
                                ...
                                <input type="text" name="writer" value="{{ old('writer', $news->writer ?? '') }}" class="neo-form-input" placeholder="Nama penulis...">
                            </div>

                            <div class="neo-form-group">
                                <label class="neo-form-label">Editor</label>
                                <input type="text" name="editor" value="{{ old('editor', $news->editor ?? '') }}" class="neo-form-input" placeholder="Nama editor...">
                            </div>

                            <div class="neo-form-group">
                                <label class="neo-form-label">Fotografer</label>
                                <input type="text" name="photographer" value="{{ old('photographer', $news->photographer ?? '') }}" class="neo-form-input" placeholder="Nama fotografer...">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="neo-card">
                    <div class="neo-card-body">
                        ...
                        @if($news->image)
                        <div class="mb-4 rounded-lg overflow-hidden border" style="border-color: var(--line);">
