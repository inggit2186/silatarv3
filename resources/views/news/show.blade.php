<x-layouts.app title="{{ $news->title }}">
    ...
    <main class="neo-mirai">
        ...
        <!-- Hero Section -->
        <section class="hero-page bg-cover bg-center" style="background-image: url('/assets/img/template/news-bg.webp'); padding: 120px 2rem 4rem; min-height: 350px;">
        ...
        <article class="page-content">
            <div class="news-article-container">
                <!-- Breadcrumb -->
                <div class="breadcrumb-nav">
                    <a href="{{ route('home') }}" onmouseover="this.style.color='var(--gold)'" onmouseout="this.style.color='var(--ink-soft)'">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                        Beranda
                    </a>
                    <span class="breadcrumb-separator">
                    ...
                    <a href="{{ route('news.index') }}" onmouseover="this.style.color='var(--gold)'" onmouseout="this.style.color='var(--ink-soft)'">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V9a2 2 0 012-2h2a2 2 0 012 2v9a2 2 0 01-2 2h-2z"/></svg>
                        Berita
                    </a>
                    <span class="breadcrumb-separator">
                    ...
                    <span class="breadcrumb-nav-current">
                ...
                <div class="neo-card">
                    ...
                    <div class="team-info-grid">
                        @if($news->writer)
                        <div class="team-card">
                            <div class="team-card-icon team-card-icon-writer">
                            ...
                            <div>
                                <p class="team-card-label">Penulis</p>
                                <p class="team-card-value">{{ $news->writer }}</p>
                            </div>
                        </div>
                        @endif
                        @if($news->editor)
                        <div class="team-card">
                            <div class="team-card-icon team-card-icon-editor">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            </div>
                            <div>
                                <p class="team-card-label">Editor</p>
                                <p class="team-card-value">{{ $news->editor }}</p>
                            </div>
                        </div>
                        @endif
                        @if($news->photographer)
                        <div class="team-card">
                            <div class="team-card-icon team-card-icon-photographer">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            </div>
                            <div>
                                <p class="team-card-label">Fotografer</p>
                                <p class="team-card-value">{{ $news->photographer }}</p>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <!-- Divider -->
                    <div class="section-divider geometric my-6"></div>
                        ...
                        <div class="share-bar">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="share-buttons">
                                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('news.show', $news->slug)) }}&text={{ urlencode($news->title) }}" target="_blank" rel="noopener" class="neo-btn-secondary share-btn" title="Twitter/X">
                                        <svg fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                    </a>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('news.show', $news->slug)) }}" target="_blank" rel="noopener" class="neo-btn-secondary share-btn" title="Facebook">
                                        <svg fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                    </a>
                                    <a href="https://wa.me/?text={{ urlencode($news->title . ' ' . route('news.show', $news->slug)) }}" target="_blank" rel="noopener" class="neo-btn-secondary share-btn" title="WhatsApp">
                                    ...
                                    <button onclick="copyToClipboard()" class="neo-btn-secondary share-btn" title="Salin Link">
        ...
        <section class="related-news-section">
            <div class="related-news-container">
                ...
                <div class="neo-grid neo-grid-3">
                    ...
                    <a href="{{ route('news.show', $related->slug ?? $related->id) }}" class="neo-service-card no-underline">
                        <div class="neo-service-cover">
                            @if($related->image)
                            <img src="{{ asset('storage/' . $related->image) }}" alt="{{ $related->title }}" class="neo-service-img">
                            @else
                            <img src="{{ asset('assets/img/template/banner-02.webp') }}" alt="{{ $related->title }}" class="neo-service-img">
                            @endif
                            <div class="neo-service-cover-overlay"></div>
                            <span class="neo-service-tag news-tag">
                                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 0 1 0 2.828l-7 7a2 2 0 0 1-2.828 0l-7-7A1.994 1.994 0 0 1 3 12V7a4 4 0 0 1 4-4z"/></svg>
                                {{ $related->category }}
                            </span>
                        </div>
                        <div class="neo-service-body">
                            <h3 class="article-card-title">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/></svg>
                                {{ $related->title }}
                            </h3>
                            ...
                            <div class="neo-service-meta">
                                <div class="neo-service-meta-item">
                                    ...
                                    <span class="neo-service-meta-value article-meta-value-icon">
