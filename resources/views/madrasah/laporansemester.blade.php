<x-layouts.app title="Laporan Semester Madrasah - SILATAR">
    <main class="neo-mirai madrasah-semester">
        <!-- Hero Section -->
        <section class="hero-page has-bg-image" style="padding: 120px 2rem 3rem; min-height: 280px;">
            <div style="max-width: 48rem; text-align: center;">
                ...
                <h1 class="hero-title">
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="1.5"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    LAPORAN SEMESTER
                </h1>
                <p class="hero-subtitle">Form input laporan semester untuk keperluan pelaporan madrasah</p>
                <div class="hero-actions">
                    <a href="{{ route('madrasah.profil') }}" class="btn-secondary">
