...
class PresensiDetailExport implements Export, WithMultipleSheets
{
    use Exportable;
...
class PresensiDetailSheet implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    protected $userId;
