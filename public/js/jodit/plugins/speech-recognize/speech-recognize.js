    ...
    ;(0,_swc_helpers_create_class__WEBPACK_IMPORTED_MODULE_2__._)(RecognizeManager, [
        ...
        },
        {
            ...
            value: function destruct() {
                this.stop();
                (0,_sound__WEBPACK_IMPORTED_MODULE_10__.closeSound)(this);
        ...
        },
        {
            ...
            value: function _makeSound(frequency) {
                if (this.sound) {
                    (0,_sound__WEBPACK_IMPORTED_MODULE_10__.sound)(this, {
                        frequency: frequency
                    });
                }
            }
...
function getContext(owner) {
    ...
    var Ctor = jodit_core_constants__WEBPACK_IMPORTED_MODULE_0__.globalWindow.AudioContext || jodit_core_constants__WEBPACK_IMPORTED_MODULE_0__.globalWindow.webkitAudioContext;
    if (!Ctor) {
        return null;
    }
...
/* harmony import */ var _swc_helpers_wrap_native_super__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(38574);
...
}((0,_swc_helpers_wrap_native_super__WEBPACK_IMPORTED_MODULE_6__._)(jodit_core_plugin__WEBPACK_IMPORTED_MODULE_11__.Plugin));
